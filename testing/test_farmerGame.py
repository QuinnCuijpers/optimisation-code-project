...
class TestFarmerGame(unittest.TestCase):
    ...
    def test_set_source_target(self):
        ...
        self.game.set_source(self.initial_state)
        self.game.set_target(self.target_state)
    ...
    def test_add_bad_states(self):
        ...
        self.game.add_bad_states([bad_state_1, bad_state_2])
    ...
    def test_add_bad_state_equal_source(self):
        ...
        with self.assertRaises(ValueError):
            self.game.add_bad_states([self.initial_state])
    ...
    def test_add_bad_state_equal_target(self):
        ...
        with self.assertRaises(ValueError):
            self.game.add_bad_states([self.target_state])
    ...
    def test_bfs_no_solution(self):
        ...
        # Block the game by adding all possible next states to bad_states
        bad_states = [
        ...
        self.game.add_bad_states(bad_states)
    ...
    def test_moves_from_path(self):
        ...
        path, success = self.game.bfs(print_actions=True)
        self.assertTrue(success)
